  ...
  driftLibrary.helpers = {
    ...
    loadItems: function (items) {
      ...
      for (let i = offset; i < length; i++) {
        ...
        <div class="inner">
        <img width="450" onclick=" driftLibrary.helpers.toggleModal(this)" data-videoUrl="${item.videoUrl}" class="content-box-thumb" src="${item.poster}" alt="tech image"  data-youtube="${item.isYoutube}"
